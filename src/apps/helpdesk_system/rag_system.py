...
Versiones alternativas:"""
    ...
    def buscar(self, consulta: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"respuesta": respuesta, "confianza": confianza, "fuentes": fuentes}
...
Respuesta:"""
        ...
        try:
            response = self.llm.invoke(
                prompt.format(consulta=consulta, contexto=contexto)
            )
    ...
    def _calcular_confianza(self, consulta: str, documentos: List) -> float:
        ...
        if palabras_consulta and total_contenido > 0:
            ...
            confianza_final = min(
                confianza_base + bonus_documentos + bonus_contenido, 1.0
            )
