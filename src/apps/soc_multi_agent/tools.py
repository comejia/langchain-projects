...
gmail_toolkit = GmailToolkit(api_resource=resource)
...
def virustotal_checker(indicator: str, indicator_type: str) -> str:
    ...
    Args:
        indicator (str): URL, IP o hash a analizar
        indicator_type (str): Tipo de indicador (url, ip, hash)
