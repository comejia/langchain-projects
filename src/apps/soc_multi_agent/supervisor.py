...
from agents import alert_agent, threat_agent, notification_agent
...
def build_soc_workflow():
    # Crear el supervisor multi-agent
    supervisor = create_supervisor(
        agents=[alert_agent, threat_agent, notification_agent],
...
EMAIL: {processing_context.get("email_recipient", "cemejia555@gmail.com")}
